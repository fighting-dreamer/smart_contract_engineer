...
// source : https://solidity-by-example.org/user-defined-value-types/
...
contract UserDefinedValueTypesExamples {
    function example_no_uvdt() external view returns (Clock) {
        // Without UDVT
        uint128 clock;
        uint64 d = 1;
